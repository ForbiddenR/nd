...
pub const HELP_BUILD: &str = "q quit | r refresh | tab switch | ↑/↓ select config | e edit context | enter build | p prune builder";
pub const HELP_BUILD_EDIT: &str =
    "enter save | esc cancel | backspace delete | ctrl-u clear | ctrl-c quit";
