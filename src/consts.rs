pub const SIDEBAR_ITEMS: [&str; 5] = ["Containers", "Images", "Build", "Build Status", "Logs"];

pub const HELP_CONTAINERS: &str = "q quit | r refresh | tab switch | ↑/↓ select | s start | x stop | R restart | d remove | p prune";
pub const HELP_IMAGES: &str = "q quit | r refresh | tab switch | ↑/↓ select | d remove | p prune | s push";
